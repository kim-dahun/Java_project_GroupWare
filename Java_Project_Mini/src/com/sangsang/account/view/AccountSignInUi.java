...
public class AccountSignInUi extends JFrame {
	...
	public void initialize() {
		...
		comboBox.setModel(new DefaultComboBoxModel(new String[] { "Management Support dept", "F&A team", "HR team",
				"CS team", "GA team", "Sales Management dept", "Sales team", "S&Support team", "S&Planning team",
				"S&Global team", "Production Management dept", "QA team", "QC team", "P&C team", "P&T team" }));
	...
	protected void clickhandleEvent(ActionEvent e) {
		...
		if (obj == btnSignIn) {
			...
			if(textID.getText().isBlank() || textPw.getText().isBlank() || textPhone.getText().isBlank() || textEmail.getText().isBlank() || textName.getText().isBlank() || comboBox.getSelectedIndex()==-1) {
