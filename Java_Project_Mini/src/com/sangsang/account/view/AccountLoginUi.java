	...
	private void initialize() {
		...
		mntmNewMenuItem_3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Integer answer = JOptionPane.showConfirmDialog(frame, "정말 종료하시겠습니까?", "종료 확인", JOptionPane.OK_CANCEL_OPTION, JOptionPane.QUESTION_MESSAGE);
		...
		textField.setBounds(274, 144, 417, 60);
		panel_loginMain.add(textField);
		textField.setColumns(10);
		
		textField_1 = new JTextField();
		textField_1.setToolTipText("영문소문자,숫자를 포함한 10자리 이상");
		...
		textField_1.setFont(new Font("D2Coding", Font.PLAIN, 22));
		textField_1.setColumns(10);
		textField_1.setBounds(274, 248, 417, 60);
		panel_loginMain.add(textField_1);
